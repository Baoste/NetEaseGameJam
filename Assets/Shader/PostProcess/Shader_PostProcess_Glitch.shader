Shader "Custom/PostProcess/Glitch"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Frag(Varyings input) : SV_Target
            {
                ...
                float r = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv + rgbOffset).r;
                float g = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv).g;
                float b = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv - rgbOffset).b;
